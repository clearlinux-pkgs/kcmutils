...
Source0  : https://download.kde.org/stable/frameworks/5.92/kcmutils-5.92.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.92/kcmutils-5.92.0.tar.xz.sig
...
%prep
%setup -q -n kcmutils-5.92.0
cd %{_builddir}/kcmutils-5.92.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647639310
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcmutils-5.92.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kcmutils/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kcmutils-5.92.0/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kcmutils/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kcmutils-5.92.0/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kcmutils/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/kcmutils-5.92.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kcmutils/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kcmutils-5.92.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kcmutils/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kcmutils-5.92.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kcmutils/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kcmutils-5.92.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kcmutils/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kcmutils-5.92.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kcmutils/cbca59e0e62dd8bfc0468847678552cadebea0a9
cp %{_builddir}/kcmutils-5.92.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kcmutils/cbca59e0e62dd8bfc0468847678552cadebea0a9
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5KCMUtils.so.5.92.0
