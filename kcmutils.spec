...
Source0  : https://download.kde.org/stable/frameworks/6.12/kcmutils-6.12.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.12/kcmutils-6.12.0.tar.xz.sig
...
%setup -q -n kcmutils-6.12.0
cd %{_builddir}/kcmutils-6.12.0
pushd ..
cp -a kcmutils-6.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742574605
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6KCMUtils.so.6.12.0
/V3/usr/lib64/libKF6KCMUtilsCore.so.6.12.0
/V3/usr/lib64/libKF6KCMUtilsQuick.so.6.12.0
...
/usr/lib64/libKF6KCMUtils.so.6.12.0
/usr/lib64/libKF6KCMUtilsCore.so.6
/usr/lib64/libKF6KCMUtilsCore.so.6.12.0
/usr/lib64/libKF6KCMUtilsQuick.so.6
/usr/lib64/libKF6KCMUtilsQuick.so.6.12.0
